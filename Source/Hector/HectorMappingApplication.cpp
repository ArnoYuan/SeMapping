...
namespace NS_HectorMapping
{
  ...
  HectorMappingApplication::HectorMappingApplication()
  {
    ...
    map_tf_srv = new NS_Service::Server< NS_ServiceType::ServiceTransform >(
        "ODOM_MAP_TF",
        boost::bind(&HectorMappingApplication::mapTransformService, this, _1));

    map_srv = new NS_Service::Server< NS_ServiceType::ServiceMap >(
        "MAP", boost::bind(&HectorMappingApplication::mapService, this, _1));
...
////////////////////////////////////////////////////////////////////////////
  ...
  void HectorMappingApplication::getMapInfo(
                                           ...
                                           unsigned int length)
  {
    ...
    boost::numeric::ublas::matrix< double > * tempPtr = new boost::numeric::ublas::matrix<
        double >(2, length);
      ...
      DataContainer& dataContainer, float scaleToMap)
  {
    ...
    for(size_t i = 0; i < size; ++i)
    {
      ...
      if((dist_sqr > sqr_laser_min_dist_) && (dist_sqr < sqr_laser_max_dist_))
      {
        ...
        if(pointPosLaserFrameZ > laser_z_min_value_ && pointPosLaserFrameZ < laser_z_max_value_)
        {
          dataContainer.add(
              Eigen::Vector2f(pointPosBaseFrame.x(), pointPosBaseFrame.y()) * scaleToMap);
  ...
  void HectorMappingApplication::updateMap(
      NS_DataType::OccupancyGrid& map, const NS_HectorMapping::GridMap& gridMap,
