  ...
  public:
                              ...
                              const DataContainer& dataPoints)
    {
      ...
      for(int i = 0; i < size; i += stepSize)
      {
        ...
        float funval = 1.0f - interpMapValue(
    ...
    float interpMapValue(const Eigen::Vector2f& coords)
    {
      ...
      return ((intensities[0] * xFacInv + intensities[1] * factors[0]) * (yFacInv)) + ((intensities[2] * xFacInv + intensities[3] * factors[0]) * (factors[1]));
    ...
    {
      return Eigen::Translation2f(transVector[0], transVector[1]) * Eigen::Rotation2Df(
          transVector[2]);
    }
