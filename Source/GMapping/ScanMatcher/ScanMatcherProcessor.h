...
namespace NS_GMapping
{
  ...
  public:
    ...
    void
    setSensorMap(const SensorMap& smap, std::string sensorName = "FLASER");
    void
    init();
    void
    ...
    void
    setRegistrationParameters(double regScore, double critScore);
    OrientedPoint
    getPose() const;
    inline const ScanMatcherMap&
    getMap() const
    {
      return m_map;
    }
    ...
    inline void setmaxMove(double mmove)
    {
      m_maxMove = mmove;
    }
    bool useICP;
